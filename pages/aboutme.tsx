        ...
        <Container>
            ...
            <div className="career">
                <Image
                    ...
                    src={
                        isPrivacy
                            ? require("../src/assets/image/FaceDummy.png")
                            : require("../src/assets/image/Face.png")
                    }
                    layout="fixed"
                    width={250}
                    height={250}
                />
                <h1>{isPrivacy ? "GAVRI" : "KIM JUNHAN"}</h1>
                <p>
                    프론트엔드 개발자 {isPrivacy ? "Gavri" : "김준한"} 입니다.
                </p>

                <h2>PROFILE</h2>
                <p>{isPrivacy ? "1996. 00. 00" : "1996. 07. 20"}</p>
                <p>{isPrivacy ? "+82 010 1234 1234" : "+82 010 9968 3484"}</p>
                <p>{isPrivacy ? "jg348434@gmail.com" : "jg348434@gmail.com"}</p>
            </div>
            <div className="project">
                <h2>EDUCATION</h2>
                <p>2015. 03. {isPrivacy ? "" : "진주 기계"}고등학교 졸업</p>
